...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String INSERT_MOVIE_TABLE = "INSERT INTO " + TABLENAME_MOVIE + " (" + COLUMN_MOVIE_name  + ", " + COLUMN_MOVIE_picture + ", " + COLUMN_MOVIE_video + ", " + COLUMN_MOVIE_duration + ", " + COLUMN_MOVIE_description + ", " + COLUMN_MOVIE_publishedDate + ") "
            ...
            + "VALUES (\"James Bond\",\"https://wallpapershome.com/images/pages/ico_v/3989.jpg\", \"\", 1.25, \"The hero James Bond likes to fight all the evil people all over the world. James Bond fights everyone while singing 'Hello' from Adele while walking on a train shooting all the bastards with his gun. At the end, the helicopter of the evil people crashes into his house, but he can escape through a hidden tunnel.\", 1631451990),"
            + "(\"IT\",\"https://d2e111jq13me73.cloudfront.net/sites/default/files/styles/product_image_aspect_switcher_170w/public/product-images/csm-movie/it-chapter-2-movie-poster-image0.jpg?itok=4j4jdwll\", \"\", 1.9, \"It is back. The clown who comes back every 25 years. Already two kids have been missing until the group of young children find out the truth\",1631451990)";

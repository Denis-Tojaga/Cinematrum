...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String INSERT_CINEMA_TABLE = "INSERT INTO " + TABLENAME_CINEMA + " (" + COLUMN_CINEMA_name + ", " + COLUMN_CINEMA_latitude + ", " + COLUMN_CINEMA_longitude  + ") "
            + "VALUES (\"Hönefoss Cinema\", 60.167459331736254, 10.256550735053501), (\"Ciname Oslo\", 59.914057645043584, 10.733265608135563), (\"Oslo Theater\", 59.87228782613781, 10.808862765353563), (\"Bergen Filmklubb\", 60.389888, 5.320926);";
    public static final String INSERT_HALL_TABLE = "INSERT INTO " + TABLENAME_HALL + " (" + COLUMN_HALL_cinemaId + ", " + COLUMN_HALL_rows + ", " + COLUMN_HALL_seatsPerRow + ") "
            + "VALUES (1,10,10), (2,10,10), (3,10,10), (4,10,10);";
    ...
    public static final String INSERT_MOVIESCINEMAS_TABLE = "INSERT INTO " + TABLENAME_MOVIES_CINEMAS + " (" + COLUMN_MOVIESCINEMAS_movieID + ", " + COLUMN_MOVIESCINEMAS_hallId + ", " + COLUMN_MOVIESCINEMAS_price + ", " + COLUMN_MOVIESCINEMAS_seatsAvailable + ", " + COLUMN_MOVIESCINEMAS_allSeats + ", " + COLUMN_MOVIESCINEMAS_date + ") "
            ...
            + "(3,1,20.99,100,100,1640710800),"
            + "(3,1,20.99,100,100,1640725200),"
            + "(3,1,20.99,100,100,1731451990),"

            + "(4,1,15.99,100,100,1641409200),"
            + "(4,2,15.99,100,100,1641409200),"
            + "(4,2,15.99,100,100,1641668400),"
            + "(4,3,17.99,100,100,1641927600),"
            + "(4,3,15.99,100,100,1642705200),"

            + "(5,4,19.99,100,100,1642705200),"
            + "(5,4,19.99,100,100,1642712400),"
            + "(5,4,19.99,100,100,1642878000),"
            + "(5,1,19.99,100,100,1642885200),"
            + "(5,1,19.99,100,100,1643137200),"
            + "(5,1,19.99,100,100,1643144400),"
            + "(5,2,21.99,100,100,1643310000),"
            + "(5,2,21.99,100,100,1643317200),"

            + "(6,4,15.99,100,100,1642705200),"
            + "(6,4,15.99,100,100,1642712400),"
            + "(6,4,15.99,100,100,1642878000),"
            + "(6,1,15.99,100,100,1642885200),"
            + "(6,1,15.99,100,100,1643137200),"
            + "(6,1,15.99,100,100,1643144400),"
            + "(6,2,17.99,100,100,1643310000),"
            + "(6,2,17.99,100,100,1643317200),"

            + "(7,4,15.99,100,100,1645650000),"
            + "(7,4,15.99,100,100,1645650000),"
            + "(7,4,15.99,100,100,1645729200),"
            + "(7,1,15.99,100,100,1645650000),"
            + "(7,1,15.99,100,100,1645650000),"
            + "(7,1,15.99,100,100,1645729200),"
            + "(7,2,17.99,100,100,1645729200),"
            + "(7,2,17.99,100,100,1645650000),"

            + "(8,4,15.99,100,100,1645650000),"
            + "(8,4,15.99,100,100,1645650000),"
            + "(8,4,15.99,100,100,1645729200),"
            + "(8,1,15.99,100,100,1645650000),"
            + "(8,1,15.99,100,100,1645650000),"
            + "(8,1,15.99,100,100,1645729200),"
            + "(8,2,17.99,100,100,1645729200),"
            + "(8,2,17.99,100,100,1645650000),"

            + "(9,4,8.99,100,100,1645650000),"
            + "(9,4,8.99,100,100,1645650000),"
            + "(9,4,8.99,100,100,1645729200),"
            + "(9,1,8.99,100,100,1645650000),"
            + "(9,1,8.99,100,100,1645650000),"
            + "(9,1,8.99,100,100,1645729200),"
            + "(9,2,8.99,100,100,1645729200),"
            + "(9,2,8.99,100,100,1645650000),"

            + "(10,4,8.99,100,100,1645650000),"
            + "(10,4,8.99,100,100,1645650000),"
            + "(10,4,8.99,100,100,1645729200),"
            + "(10,1,8.99,100,100,1645650000),"
            + "(10,1,8.99,100,100,1645650000),"
            + "(10,1,8.99,100,100,1645729200),"
            + "(10,2,8.99,100,100,1645729200),"
            + "(10,2,8.99,100,100,1645650000),"

            + "(11,4,8.99,100,100,1645650000),"
            + "(11,4,8.99,100,100,1645650000),"
            + "(11,4,8.99,100,100,1645729200),"
            + "(11,1,8.99,100,100,1645650000),"
            + "(11,1,8.99,100,100,1645650000),"
            + "(11,1,8.99,100,100,1645729200),"
            + "(11,2,8.99,100,100,1645729200),"
            + "(11,2,8.99,100,100,1645650000),"

            + "(12,4,8.99,100,100,1645650000),"
            + "(12,4,8.99,100,100,1645650000),"
            + "(12,4,8.99,100,100,1645729200),"
            + "(12,1,8.99,100,100,1645650000),"
            + "(12,1,8.99,100,100,1645650000),"
            + "(12,1,8.99,100,100,1645729200),"
            + "(12,2,8.99,100,100,1645729200),"
            + "(12,2,8.99,100,100,1645650000),"

            + "(13,4,8.99,100,100,1645650000),"
            + "(13,4,8.99,100,100,1645650000),"
            + "(13,4,8.99,100,100,1645729200),"
            + "(13,1,8.99,100,100,1645650000),"
            + "(13,1,8.99,100,100,1645650000),"
            + "(13,1,8.99,100,100,1645729200),"
            + "(13,2,8.99,100,100,1645729200),"
            + "(13,2,8.99,100,100,1645650000),"

            + "(14,4,8.99,100,100,1645650000),"
            + "(14,4,8.99,100,100,1645650000),"
            + "(14,4,8.99,100,100,1645729200),"
            + "(14,1,8.99,100,100,1645650000),"
            + "(14,1,8.99,100,100,1645650000),"
            + "(14,1,8.99,100,100,1645729200),"
            + "(14,2,8.99,100,100,1645729200),"
            + "(14,2,8.99,100,100,1645650000),"

            + "(15,4,8.99,100,100,1645650000),"
            + "(15,4,8.99,100,100,1645650000),"
            + "(15,4,8.99,100,100,1645729200),"
            + "(15,1,8.99,100,100,1645650000),"
            + "(15,1,8.99,100,100,1645650000),"
            + "(15,1,8.99,100,100,1645729200),"
            + "(15,2,8.99,100,100,1645729200),"
            + "(15,2,8.99,100,100,1645650000),"

            + "(16,4,8.99,100,100,1645650000),"
            + "(16,4,8.99,100,100,1645650000),"
            + "(16,4,8.99,100,100,1645729200),"
            + "(16,1,8.99,100,100,1645650000),"
            + "(16,1,8.99,100,100,1645650000),"
            + "(16,1,8.99,100,100,1645729200),"
            + "(16,2,8.99,100,100,1645729200),"
            + "(16,2,8.99,100,100,1645650000),"

            + "(17,4,8.99,100,100,1645650000),"
            + "(17,4,8.99,100,100,1645650000),"
            + "(17,4,8.99,100,100,1645729200),"
            + "(17,1,8.99,100,100,1645650000),"
            + "(17,1,8.99,100,100,1645650000),"
            + "(17,1,8.99,100,100,1645729200),"
            + "(17,2,8.99,100,100,1645729200),"
            + "(17,2,8.99,100,100,1645650000),"

            + "(18,4,8.99,100,100,1645650000),"
            + "(18,4,8.99,100,100,1645650000),"
            + "(18,4,8.99,100,100,1645729200),"
            + "(18,1,8.99,100,100,1645650000),"
            + "(18,1,8.99,100,100,1645650000),"
            + "(18,1,8.99,100,100,1645729200),"
            + "(18,2,8.99,100,100,1645729200),"
            + "(18,2,8.99,100,100,1645650000),"
            ...
            + "(19,4,8.99,100,100,1645650000),"
            + "(19,4,8.99,100,100,1645650000),"
            + "(19,4,8.99,100,100,1645729200),"
            + "(19,1,8.99,100,100,1645650000),"
            + "(19,1,8.99,100,100,1645650000),"
            + "(19,1,8.99,100,100,1645729200),"
            + "(19,2,8.99,100,100,1645729200),"
            + "(19,2,8.99,100,100,1645650000),"

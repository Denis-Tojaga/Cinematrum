...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String INSERT_USER_TABLE = "INSERT INTO " + TABLENAME_USER + " (" + COLUMN_USER_username + ", " + COLUMN_USER_email + ", " + COLUMN_USER_password + ", " + COLUMN_USER_userType + ", " + COLUMN_USER_telephone + ") "
            + "VALUES (\"user1\",\"email1\", \"password1\", \"admin\", 01234),"
            + "(\"user3\",\"email2\", \"password3\", \"user\", 012348790809),"
            + "(\"user2\",\"email3\", \"password2\", \"user\", 012348790809);";
